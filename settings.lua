...
local mod_id = "DarkAtlas" -- This should match the name of your mod's folder.
...
mod_settings = 
{
	...
	},
	{
		id = "PERK_MODE_TOGGLE",
		ui_name = "Perk Mode",
		ui_description = "Turns the skin into a perk for multiplayer, via item you spawn with.",
		value_default = true,
		scope = MOD_SETTING_SCOPE_NEW_GAME,
	},
	{
